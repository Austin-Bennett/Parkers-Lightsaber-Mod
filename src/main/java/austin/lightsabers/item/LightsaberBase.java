...
public class LightsaberBase extends ToolItem implements Vanishable {
    private final float attackDamage;
    private final Multimap<EntityAttribute, EntityAttributeModifier> attributeModifiers;

    public LightsaberBase(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Item.Settings settings) {
